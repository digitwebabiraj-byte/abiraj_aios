...
Holds validation records that decide whether an asset meets its requirement, including queryability checks and explicit PASS / FAIL outcomes.

## Accepted Assets

- Validation reports and checklists
- Queryability tests (can an LLM answer from the saved files?)
- Explicit PASS / FAIL decisions with linked evidence

## Not Allowed

- PASS / FAIL decisions with no supporting evidence
- Validation of work that has no approved requirement
- Business sign-off that belongs to a Business Validator role
