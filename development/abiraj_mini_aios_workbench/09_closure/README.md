...
Holds task closure records that capture final status, asset paths, evidence paths, reviewers, blockers and exactly one next action per closed task.

## Accepted Assets

- Task closure records with final status
- Asset, evidence and validation path references
- Recorded reviewers, genuine blockers and one next action

## Not Allowed

- Closure claims with no evidence or validation reference
- Multiple competing final statuses for the same task
- Closure of work that was never approved
