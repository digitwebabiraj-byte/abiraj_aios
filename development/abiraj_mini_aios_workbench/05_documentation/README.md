...
Holds reusable operating documentation that explains how this subfolder is run, so the workflow is understandable without verbal explanation.

## Accepted Assets

- Workflow explanations and operating guides
- Reusable README and how-to documentation
- Approved guidance and conventions

## Not Allowed

- Task evidence (belongs in 06_evidence)
- Unsupported claims or undocumented opinions
- Duplicate copies of documentation already held elsewhere
