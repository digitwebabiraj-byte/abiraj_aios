...
.app{display:flex;flex-direction:column;height:100vh;padding:14px 18px 12px;gap:11px}
...
.tableCard{flex:1;min-height:0;display:flex;flex-direction:column;background:var(--surface);border:1px solid var(--line);border-radius:14px;
