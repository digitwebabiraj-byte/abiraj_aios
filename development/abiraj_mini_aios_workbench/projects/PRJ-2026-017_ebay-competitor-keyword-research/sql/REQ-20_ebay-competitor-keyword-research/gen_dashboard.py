...
thead th{position:sticky;top:0;z-index:6;background:linear-gradient(180deg,#f2f7ff,#e9f1fb);
 color:#38495f;text-align:left;font-size:10.5px;text-transform:uppercase;letter-spacing:.5px;font-weight:800;
 padding:13px 13px;border-bottom:2px solid var(--band-line)}
