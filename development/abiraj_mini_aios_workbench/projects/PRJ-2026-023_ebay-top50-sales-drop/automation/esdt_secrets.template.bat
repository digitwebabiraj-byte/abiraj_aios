@echo off
REM ==== ESDT credentials — copy to esdt_secrets.bat and fill in; it is git-ignored ====
...
set "LED_PGPASSWORD="
REM Portal publish (temp_user @ order_management_copy) — refreshes all esdt ph_task rows each run.
