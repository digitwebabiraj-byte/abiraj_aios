...
.app{display:flex;flex-direction:column;max-width:1680px;margin:0 auto;padding:7px 18px 10px}
...
.scroll{overflow:auto;height:clamp(680px, calc(100vh - 138px), 2400px)}
