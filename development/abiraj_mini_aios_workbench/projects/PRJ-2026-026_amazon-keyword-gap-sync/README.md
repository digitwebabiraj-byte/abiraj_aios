...
terms → 49 underperforming listings → **Part A 1 rewrite + Part B 136 real gaps + Part C 3
rejected (wrong SKU)**, keywords floored at 10 searches/month for the work list. Uses `mapped_sku`, the source's own SKU mapping table. Verified in-browser and
