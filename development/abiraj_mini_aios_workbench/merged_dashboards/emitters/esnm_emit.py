...
SRC = os.environ.get("ESNM_SRC") or os.path.join(BASE, r"PRJ-2026-014_ebay-slow-no-moving-products\evidence\final_outputs\REQ-16_ebay-slow-no-moving-products\esnm_d01_data.json")
