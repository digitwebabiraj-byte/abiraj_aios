...
SPEC = [
    ...
    ("f_amz",   "Amazon sold Qty",  "Amazon Qty",      "metric", "num"),
    ("f_ebay",  "eBay sold Qty",    "eBay Qty",        "metric", "num"),
    ("f_shop",  "Shopify sold Qty", "Shopify Qty",     "metric", "num"),
    ("f_units", "Total Units Sold", "Total Units",     "metric", "num"),
    ("f_rev",   "Total Revenue",    "Revenue",         "metric", "money"),
